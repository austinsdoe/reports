...
def _cache_key_select_client(
        method, self, allow_blank=True, multiselect=False,
        style=None):
    """
    This function returns the key used to decide if method select_client has to be recomputed
    """
    key = update_timer(), style, allow_blank, multiselect
    return key
...
def _cache_key_select_output_format(
        method, self, style=None, formats=['PDF', 'CSV']):
    """
    This function returns the key used to decide if method select_output_format has to be recomputed
    """
    key = update_timer(), style, formats
    return key
...
class SelectionMacrosView(BrowserView):
    ...
    def __init__(self, context, request):
        ...
        self.clients = None
        self.analysisservices = None
        self.analysiscategories = None
        self.contacts = None
        self.analysts = None
        self.sampletypes = None
        self.instruments = None
        self.samplepoints = None
        self.specs = None
        self.analysisprofiles = None
        self.suppliers = None
